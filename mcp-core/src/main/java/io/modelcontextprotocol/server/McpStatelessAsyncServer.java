...
public class McpStatelessAsyncServer {
	...
	private McpStatelessRequestHandler<McpSchema.ListToolsResult> toolsListRequestHandler() {
		return (ctx, params) -> {
			...
			var requestedStartIndex = handleCursor(paginatedRequest.cursor(), mapSize, mapHash).block();
			...
			return Mono.just(McpSchema.ListToolsResult.builder(resultList).nextCursor(nextCursor).build());
		};
	}
	...
	private McpStatelessRequestHandler<McpSchema.ListResourcesResult> resourcesListRequestHandler() {
		return (ctx, params) -> {
			...
			return Mono.just(McpSchema.ListResourcesResult.builder(resultList).nextCursor(nextCursor).build());
		};
	}
	...
	private McpStatelessRequestHandler<McpSchema.ListResourceTemplatesResult> resourceTemplateListRequestHandler() {
		return (ctx, params) -> {
			...
			return Mono.just(McpSchema.ListResourceTemplatesResult.builder(resultList).nextCursor(nextCursor).build());
		};
	}
	...
	private McpStatelessRequestHandler<McpSchema.ListPromptsResult> promptsListRequestHandler() {
		return (ctx, params) -> {
			...
			return Mono.just(McpSchema.ListPromptsResult.builder(resultList).nextCursor(nextCursor).build());
		};
	}
